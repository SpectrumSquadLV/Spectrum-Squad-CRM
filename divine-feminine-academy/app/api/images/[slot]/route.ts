 ...
 *
 * The caching is the interesting part. Every <img> asks for ?v=<version>, and
 ...
 * a year. Replacing a photograph changes the URL, which means it appears
 * immediately for everybody instead of some visitors seeing last month's
 * picture until their cache gives up.
 *
...
export async function GET(
  ...
  const row = await siteImageBytes(slot)
