 ...
 * and that one of them is hers. She cannot see which. That is the whole
 * mechanic of an oracle spread and it is the only honest way to show the four
 * before she has earned them.
 *
      ...
      <div className="flex justify-center gap-2 sm:gap-4">
        {modes.map((mode, i) => (
          ...
          >
            ...
            <Sigil mode={mode} className="h-7 w-7 sm:h-10 sm:w-10" />
            {/*
            ...
            <span
              aria-hidden="true"
              className="h-px w-6 bg-bone/30 sm:w-8"
            />
          </div>
        ))}
      </div>
