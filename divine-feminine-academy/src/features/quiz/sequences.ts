  ...
  fight: [
    {
      ...
      heading: 'Here she is.',
      paragraphs: [
        `${FIRST_NAME_TOKEN}, you came out as The Commander — the version of you who gets bigger, faster and more capable the second something threatens you. And does it alone.`,
        'You already know the behaviour. What you might not know is what it is for.',
  ...
  flight: [
    {
      ...
      heading: 'Here she is.',
      paragraphs: [
        `${FIRST_NAME_TOKEN}, you came out as The Escape Artist — the version of you who finds the exit before anything can find her. A new plan, a new city, a new version of your life.`,
        'You already know the behaviour. What you might not know is what it is for.',
  ...
  freeze: [
    {
      ...
      heading: 'Here she is.',
      paragraphs: [
        `${FIRST_NAME_TOKEN}, you came out as The Watcher — the version of you who goes still. Researching, preparing, almost-ready, because moving in the wrong direction feels worse than not moving at all.`,
        'You already know the behaviour. What you might not know is what it is for.',
  ...
  sulk: [
    {
      ...
      heading: 'Here she is.',
      paragraphs: [
        `${FIRST_NAME_TOKEN}, you came out as The Quiet Storm — the version of you who withdraws. Who says she is fine, gives a little less, and waits to be noticed.`,
        'You already know the behaviour. What you might not know is what it is for.',
